...
- **ProPresenter Automations** – Python service that auto-triggers OBS scene changes during video playback  
  `https://github.com/ThriveCommunityChurch/ProPresenter_Automations`
- **Thrive Stream Controller** – One-click stream management web app (Docker, .NET/React)  
  `https://github.com/ThriveCommunityChurch/Thrive_Stream_Controller`
