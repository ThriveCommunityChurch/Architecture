...
- A **Livestream & Production System** that captures, switches, and streams services to Facebook and YouTube
...
1. **Sunday** – The service is captured by three cameras through the ATEM switcher, streamed live via OBS, and recorded. ProPresenter handles graphics and NDI overlay. See [Livestream & Production](livestream-production.md) for the full signal flow.
...
- **OBS Studio** and **ProPresenter 7** for livestream production and graphics
- A **Blackmagic ATEM** video switcher with three Canon C100 II cameras
- **ProPresenter Automations** (Python) for automated OBS scene switching
- **Thrive Stream Controller** (Docker, .NET/React) for one-click stream management
